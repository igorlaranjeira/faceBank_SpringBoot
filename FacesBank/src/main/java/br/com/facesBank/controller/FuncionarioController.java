package br.com.facesBank.controller;
...
public class FuncionarioController {
	...
	@PostMapping("/salvar")
	public String salvar(@Valid FuncionarioEntity funcionario, BindingResult result, RedirectAttributes attr) {
	...
	@PostMapping("/editar")
	public String editar(@Valid FuncionarioEntity funcionario, BindingResult result, RedirectAttributes attr) {
